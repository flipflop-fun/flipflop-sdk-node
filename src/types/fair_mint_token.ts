...
export type FairMintToken = {
  ...
  instructions: [
    {
      ...
      discriminator: [255, 254, 39, 14, 229, 37, 89, 240];
      accounts: [
        {
          name: "mint";
          writable: true;
          pda: {
            seeds: [
              {
                kind: "const";
                value: [102, 97, 105, 114, 95, 109, 105, 110, 116];
              },
              {
                kind: "arg";
                path: "tokenName";
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [99, 111, 110, 102, 105, 103, 95, 100, 97, 116, 97];
              },
              {
                kind: "account";
                path: "mint";
    ...
    },
    {
      ...
      docs: ["Delegate value manager"];
      discriminator: [65, 71, 81, 199, 83, 64, 181, 167];
      accounts: [
        {
          name: "admin";
          writable: true;
    ...
    },
    {
      ...
      docs: ["Initialize launch rule"];
      discriminator: [61, 250, 188, 110, 91, 75, 249, 62];
      accounts: [
        {
          name: "admin";
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [108, 97, 117, 110, 99, 104, 95, 114, 117, 108, 101];
              },
              {
                kind: "account";
                path: "admin";
    ...
    },
    {
      ...
      docs: ["Burn lp tokens"];
      discriminator: [215, 41, 48, 70, 81, 221, 246, 105];
      accounts: [
        {
          name: "admin";
          writable: true;
        ...
        {
          name: "ownerLpToken";
          docs: ["Owner lp tokan account - config account"];
          writable: true;
        },
        {
          name: "lpMint";
    ...
    {
      name: "proxyDeposit";
      docs: ["Initiazlize a swap pool (Deprated)", "deposit instruction"];
      discriminator: [99, 49, 91, 137, 172, 25, 207, 21];
      accounts: [
        {
          name: "cpSwapProgram";
          address: "CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C";
    ...
    },
    {
      ...
      docs: ["swap_base_in instruction"];
      discriminator: [250, 174, 212, 217, 47, 84, 212, 231];
      accounts: [
        {
          name: "cpSwapProgram";
          address: "CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C";
    ...
    },
    {
      ...
      docs: ["swap_base_out instruction"];
      discriminator: [194, 15, 252, 249, 72, 54, 250, 85];
      accounts: [
        {
          name: "cpSwapProgram";
          address: "CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C";
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "protocolFeeAccount";
          docs: ["CHECK the protocol fee account"];
          writable: true;
        },
        {
          name: "systemConfigAccount";
    ...
    },
    {
      ...
      docs: ["Revoke update token2022 metadata authority"];
      discriminator: [16, 230, 0, 225, 47, 138, 113, 90];
      accounts: [
        {
          name: "mint";
          writable: true;
    ...
    },
    {
      ...
      docs: ["Set referrer code"];
      discriminator: [129, 47, 113, 211, 151, 134, 156, 250];
      accounts: [
        {
          name: "payer";
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [99, 111, 100, 101, 95, 97, 99, 99, 111, 117, 110, 116];
              },
              {
                kind: "arg";
                path: "codeHash";
    ...
    },
    {
      name: "updateSystem";
      docs: ["Update system"];
      discriminator: [63, 147, 183, 92, 22, 242, 219, 4];
      accounts: [
        {
          name: "admin";
          writable: true;
  ...
  accounts: [
    ...
    },
    {
      ...
      discriminator: [223, 104, 233, 118, 230, 133, 135, 33];
    },
    {
      name: "launchRuleData";
      discriminator: [219, 140, 239, 85, 135, 107, 8, 102];
    },
    {
      name: "observationState";
    ...
    },
    {
      ...
      discriminator: [192, 35, 167, 45, 153, 226, 213, 45];
    },
    {
      name: "tokenConfigData";
      discriminator: [38, 179, 204, 76, 50, 176, 214, 81];
    },
    {
      name: "tokenReferralData";
      discriminator: [136, 185, 38, 182, 42, 126, 118, 45];
    },
    {
      name: "tokenRefundData";
      discriminator: [16, 160, 38, 231, 81, 131, 138, 105];
    }
  ];
  events: [
    {
      name: "closeTokenEvent";
      discriminator: [203, 9, 156, 247, 207, 50, 200, 219];
    },
    {
      name: "initializeTokenEvent";
      discriminator: [108, 41, 10, 194, 65, 120, 212, 118];
    },
    {
      name: "mintEvent";
    ...
    },
    {
      ...
      discriminator: [156, 230, 12, 212, 118, 228, 15, 218];
    },
    {
      name: "updateTokenMetadataEvent";
      discriminator: [203, 161, 251, 30, 78, 127, 196, 227];
    }
  ];
  errors: [
    {
